...
import { Search, Calendar, Users, MessageCircle, CreditCard, MapPin, Phone, Mail, Instagram, ChevronRight, ArrowLeft, Star, Clock, BookOpen, Heart, Send, Menu, X, ExternalLink, Shield, Info, Home, Plus, Check, AlertCircle, User, LogOut, ChevronDown, ChevronUp, Lock, Eye, EyeOff, FileText, Link2, Paperclip } from "lucide-react";
...
const STUDY_GROUPS = [
  { id: 1, unit: "BIT210", title: "Web Development Study Group", members: 8, max: 12, campus: "Footscray Park", day: "Monday 2-4pm", desc: "Weekly HTML/CSS/JS practice sessions",
    chat: [
      { id: 1, author: "Mei L.", text: "Hey everyone! Just uploaded my notes from last week's lecture on CSS Grid. Check the resources tab.", time: "Mon 2:15 PM" },
      { id: 2, author: "James K.", text: "Thanks Mei! Super helpful. Anyone else struggling with the flexbox assignment?", time: "Mon 2:22 PM" },
      { id: 3, author: "Sarah M.", text: "I found a great YouTube tutorial on flexbox. Will share the link in resources.", time: "Mon 2:30 PM" },
      { id: 4, author: "Anonymous", text: "Can we go over responsive design next session? I'm really behind on that topic.", time: "Mon 3:01 PM" },
      { id: 5, author: "Mei L.", text: "Absolutely! Let's dedicate the first hour to responsive design next Monday.", time: "Mon 3:10 PM" },
    ],
    resources: [
      { id: 1, title: "CSS Grid Complete Guide", type: "link", author: "Mei L.", time: "2 days ago" },
      { id: 2, title: "Week 5 Lecture Notes.pdf", type: "file", author: "Mei L.", time: "2 days ago" },
      { id: 3, title: "Flexbox Tutorial (YouTube)", type: "link", author: "Sarah M.", time: "1 day ago" },
      { id: 4, title: "Assignment 2 - Starter Template.zip", type: "file", author: "James K.", time: "5 hours ago" },
    ]
  },
  { id: 2, unit: "BCO215", title: "Database Systems Revision", members: 5, max: 10, campus: "City Tower", day: "Wednesday 10am-12pm", desc: "SQL queries and ER diagrams review",
    chat: [
      { id: 1, author: "David R.", text: "Does anyone have practice questions for normalisation? The textbook ones are too easy.", time: "Wed 10:05 AM" },
      { id: 2, author: "Sarah M.", text: "I have a set from last year's exam. Will upload them now.", time: "Wed 10:12 AM" },
      { id: 3, author: "Anonymous", text: "Can someone explain 3NF vs BCNF? I keep mixing them up.", time: "Wed 10:30 AM" },
      { id: 4, author: "David R.", text: "3NF allows some redundancy if the determinant is a candidate key. BCNF is stricter - every determinant must be a superkey.", time: "Wed 10:35 AM" },
    ],
    resources: [
      { id: 1, title: "Normalisation Practice Set", type: "file", author: "Sarah M.", time: "3 days ago" },
      { id: 2, title: "SQL Cheat Sheet", type: "link", author: "David R.", time: "1 week ago" },
    ]
  },
  { id: 3, unit: "BIT310", title: "Software Engineering Project Team", members: 6, max: 8, campus: "Footscray Park", day: "Thursday 1-3pm", desc: "Agile sprint planning and code reviews",
    chat: [
      { id: 1, author: "Alex T.", text: "Sprint 3 starts tomorrow. Everyone update your Jira tickets please.", time: "Thu 1:00 PM" },
      { id: 2, author: "Mei L.", text: "Done. I've moved my tasks to 'In Progress'. PR for the login module is ready for review.", time: "Thu 1:15 PM" },
      { id: 3, author: "James K.", text: "I'll review it this afternoon. Can we pair program on the API integration tomorrow?", time: "Thu 1:22 PM" },
    ],
    resources: [
      { id: 1, title: "Sprint 3 Planning Doc", type: "file", author: "Alex T.", time: "1 day ago" },
      { id: 2, title: "GitHub Repo Link", type: "link", author: "Alex T.", time: "2 weeks ago" },
      { id: 3, title: "System Architecture Diagram.png", type: "file", author: "Mei L.", time: "4 days ago" },
    ]
  },
  { id: 4, unit: "BAO220", title: "Accounting Principles Help", members: 4, max: 10, campus: "City Tower", day: "Tuesday 3-5pm", desc: "Problem-solving for assignments and exam prep",
    chat: [
      { id: 1, author: "Priya S.", text: "Has anyone started the depreciation worksheet? I'm stuck on question 4.", time: "Tue 3:10 PM" },
      { id: 2, author: "Anonymous", text: "Same here. The reducing balance method is confusing me.", time: "Tue 3:18 PM" },
      { id: 3, author: "Tom W.", text: "I can walk through it at our next session. It's easier than it looks once you get the formula down.", time: "Tue 3:25 PM" },
    ],
    resources: [
      { id: 1, title: "Depreciation Methods Summary", type: "file", author: "Tom W.", time: "3 days ago" },
    ]
  },
  { id: 5, unit: "BEO224", title: "Business Analytics Lab", members: 7, max: 10, campus: "Footscray Park", day: "Friday 11am-1pm", desc: "Excel, Tableau and data analysis practice",
    chat: [
      { id: 1, author: "Lisa C.", text: "The Tableau assignment is due next Friday. Anyone want to work on it together this weekend?", time: "Fri 11:05 AM" },
      { id: 2, author: "James K.", text: "I'm in. Saturday morning at the library?", time: "Fri 11:12 AM" },
      { id: 3, author: "Lisa C.", text: "Perfect. I'll book a study room. 10am work?", time: "Fri 11:15 AM" },
      { id: 4, author: "Anonymous", text: "Count me in too!", time: "Fri 11:20 AM" },
    ],
    resources: [
      { id: 1, title: "Tableau Getting Started Guide", type: "link", author: "Lisa C.", time: "1 week ago" },
      { id: 2, title: "Sample Dataset - Sales.csv", type: "file", author: "Lisa C.", time: "5 days ago" },
      { id: 3, title: "Pivot Table Tutorial.pdf", type: "file", author: "James K.", time: "2 days ago" },
    ]
  },
];
...
export default function CampusConnectApp() {
  ...
  const goBack = () => { const stack = [...screenStack]; const prev = stack.pop(); setScreenStack(stack); setScreen(prev || "home"); setLeaveConfirm(false); };
  ...
  const processCardPayment = () => {
    ...
    setProcessing(true);
    setTimeout(() => { setProcessing(false); setPaymentDone(true); setShowPayment(false); setPaymentMethod(null); showToast("Payment successful!"); }, 2000);
  };

  const getGroupChats = (gid) => {
    const g = STUDY_GROUPS.find(x => x.id === gid);
    const extra = groupChats[gid] || [];
    return [...(g?.chat || []), ...extra];
  };

  const sendGroupChat = (gid) => {
    if (!groupChatInput.trim()) return;
    const msg = { id: Date.now(), author: profile.name || "You", text: groupChatInput, time: "Just now" };
    setGroupChats(prev => ({ ...prev, [gid]: [...(prev[gid] || []), msg] }));
    setGroupChatInput("");
  };

  const openGroupDetail = (gid) => {
  ...
  const leaveGroup = (gid) => {
    setJoinedGroups(prev => prev.filter(id => id !== gid));
  ...
  // === LOGIN ===
  if (!isLoggedIn) {
    const handleLogin = () => { setLoginError(""); if (!loginEmail.includes("@") || loginPass.length < 6) { setLoginError("Valid email and password (6+ chars) required."); return; } setProfile(p => ({ ...p, email: loginEmail })); setIsLoggedIn(true); };
    const handleSignup = () => { setLoginError(""); if (!signupName.trim() || !signupEmail.includes("@") || signupPass.length < 6) { setLoginError("Name, valid email, and password (6+ chars) required."); return; } setProfile(p => ({ ...p, name: signupName, email: signupEmail })); setIsLoggedIn(true); };
    return (
      <div style={{ fontFamily: "'Inter', -apple-system, sans-serif", background: C.bg, minHeight: "100vh", maxWidth: 430, margin: "0 auto", borderLeft: `1px solid ${C.border}`, borderRight: `1px solid ${C.border}` }}>
        ...
        <div style={{ padding: "24px 24px 40px" }}>
          ...
          {loginTab === "login" ? (<>
            ...
            <label style={{ fontSize: 13, fontWeight: 600, color: C.textSec, display: "block", marginBottom: 6 }}>Password</label>
            <div style={{ position: "relative", marginBottom: 20 }}><Lock size={18} style={{ position: "absolute", left: 12, top: 13, color: C.textSec }} /><input value={signupPass} onChange={e => setSignupPass(e.target.value)} placeholder="Min 6 characters" type={showPass ? "text" : "password"} style={{ ...si, paddingLeft: 38, paddingRight: 42 }} /><button onClick={() => setShowPass(!showPass)} style={{ position: "absolute", right: 10, top: 10, background: "none", border: "none", cursor: "pointer", color: C.textSec }}>{showPass ? <EyeOff size={18} /> : <Eye size={18} />}</button></div>
            <button onClick={handleSignup} style={sbtn}>Create Account</button>
          </>)}
  ...
  const rsvpEvent = (id) => { if (!rsvpEvents.includes(id)) { setRsvpEvents([...rsvpEvents, id]); showToast("RSVP confirmed!"); }};
      ...
      <div style={{ padding: "16px 20px" }}>
        ...
        {groupTab === "chat" && (<>
          <div style={{ marginBottom: 12 }}>
            {chats.map(m => {
              const isMe = m.author === (profile.name || "You") || m.author === "You";
              return (
                <div key={m.id} style={{ display: "flex", flexDirection: isMe ? "row-reverse" : "row", gap: 8, marginBottom: 10 }}>
                  <div style={{ width: 30, height: 30, borderRadius: "50%", background: isMe ? C.accent + "20" : C.textSec + "15", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 12, fontWeight: 700, color: isMe ? C.accent : C.textSec, flexShrink: 0 }}>{m.author[0]}</div>
                  <div style={{ maxWidth: "75%" }}>
                    <div style={{ fontSize: 11, fontWeight: 600, color: C.textSec, marginBottom: 2, textAlign: isMe ? "right" : "left" }}>{m.author}</div>
                    <div style={{ background: isMe ? C.accent : "#f0f2f5", color: isMe ? "#fff" : C.text, padding: "10px 14px", borderRadius: 14, borderTopLeftRadius: isMe ? 14 : 4, borderTopRightRadius: isMe ? 4 : 14, fontSize: 14, lineHeight: 1.45 }}>{m.text}</div>
                    <div style={{ fontSize: 10, color: C.textSec, marginTop: 2, textAlign: isMe ? "right" : "left" }}>{m.time}</div>
                  </div>
                </div>
              );
            })}
          </div>
          <div style={{ display: "flex", gap: 8, position: "sticky", bottom: 70, background: C.bg, padding: "8px 0" }}>
            <input value={groupChatInput} onChange={e => setGroupChatInput(e.target.value)} onKeyDown={e => { if (e.key === "Enter") sendGroupChat(g.id); }} placeholder="Type a message..." style={{ ...si, padding: "10px 14px", fontSize: 14 }} />
            <button onClick={() => sendGroupChat(g.id)} style={{ background: C.accent, color: "#fff", border: "none", borderRadius: 10, padding: "10px 14px", cursor: "pointer", display: "flex", flexShrink: 0 }}><Send size={18} /></button>
          </div>
        </>)}

        {/* RESOURCES TAB */}
        {groupTab === "resources" && (<>
          <div style={{ fontSize: 14, fontWeight: 700, color: C.text, marginBottom: 12 }}>Shared Resources</div>
          {g.resources.map(r => (
            <div key={r.id} style={{ ...scard, display: "flex", alignItems: "center", gap: 12 }}>
              <div style={{ background: r.type === "file" ? "#e8f5e9" : C.accentLight, borderRadius: 10, padding: 10, display: "flex" }}>
                {r.type === "file" ? <FileText size={20} color={C.success} /> : <Link2 size={20} color={C.accent} />}
              </div>
              <div style={{ flex: 1 }}>
                <div style={{ fontSize: 14, fontWeight: 600, color: C.text }}>{r.title}</div>
                <div style={{ fontSize: 12, color: C.textSec }}>Shared by {r.author} - {r.time}</div>
              </div>
            </div>
          ))}
          <button onClick={() => showToast("File picker would open here")} style={{ ...sbtn, background: C.accent, marginTop: 8 }}><Paperclip size={16} /> Share a Resource</button>
        </>)}

        {/* SETTINGS TAB */}
        {groupTab === "info" && (<>
          <div style={scard}>
            <div style={{ fontSize: 16, fontWeight: 700, color: C.text, marginBottom: 12 }}>Group Details</div>
            <div style={{ fontSize: 14, color: C.text, lineHeight: 2 }}>
              <strong>Unit Code:</strong> {g.unit}<br/>
              <strong>Group Name:</strong> {g.title}<br/>
              <strong>Schedule:</strong> {g.day}<br/>
              <strong>Campus:</strong> {g.campus}<br/>
              <strong>Members:</strong> {g.members}/{g.max}<br/>
              <strong>Description:</strong> {g.desc}
            </div>
          </div>
          <div style={scard}>
            <div style={{ fontSize: 16, fontWeight: 700, color: C.text, marginBottom: 12 }}>Members</div>
            {["Mei L.", "James K.", "Sarah M.", "David R.", "You"].slice(0, g.members > 5 ? 5 : g.members).map((name, i) => (
              <div key={i} style={{ display: "flex", alignItems: "center", gap: 10, padding: "8px 0", borderBottom: i < 4 ? `1px solid ${C.border}` : "none" }}>
                <div style={{ width: 32, height: 32, borderRadius: "50%", background: name === "You" ? C.accent + "20" : C.textSec + "15", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 13, fontWeight: 700, color: name === "You" ? C.accent : C.textSec }}>{name[0]}</div>
                <span style={{ fontSize: 14, color: C.text, fontWeight: name === "You" ? 700 : 400 }}>{name === "You" ? (profile.name || "You") + " (You)" : name}</span>
              </div>
            ))}
            {g.members > 5 && <div style={{ fontSize: 12, color: C.textSec, padding: "8px 0" }}>+{g.members - 5} more members</div>}
          </div>
          {/* Leave Group */}
          {!leaveConfirm ? (
            <button onClick={() => setLeaveConfirm(true)} style={{ ...sbtn, background: "transparent", color: C.danger, border: `2px solid ${C.danger}` }}>
              <LogOut size={16} /> Leave Group
            </button>
          ) : (
            <div style={{ ...scard, borderColor: C.danger + "40", background: "#fff5f5" }}>
              <div style={{ fontSize: 15, fontWeight: 700, color: C.danger, marginBottom: 6 }}>Leave this group?</div>
              <p style={{ fontSize: 13, color: C.textSec, marginBottom: 14 }}>You will lose access to the group chat and resources. You can rejoin anytime if spots are available.</p>
              <div style={{ display: "flex", gap: 8 }}>
                <button onClick={() => leaveGroup(g.id)} style={{ ...sbtn, background: C.danger, flex: 1 }}>Yes, Leave</button>
                <button onClick={() => setLeaveConfirm(false)} style={{ ...sbtn, background: "transparent", color: C.textSec, border: `1.5px solid ${C.border}`, flex: 1 }}>Cancel</button>
              </div>
            </div>
          )}
        </>)}
